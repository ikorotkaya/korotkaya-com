export const projects = [
  {
    ...
    description: "Explore Berlin's well-known sites and hidden gems with Miles Experiences. Calculate your travel expenses and journey duration to your selected destination with ease.",
